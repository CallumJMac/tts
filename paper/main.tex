...
\begin{figure}[t]
  ...
  Points show per-configuration means with $\pm$1~SD error bars; color encodes approach, marker shape encodes selection strategy, and marker size encodes number of references.
...
\begin{figure}[t]
  ...
  Failures occur only in \textsc{concat} settings, while \textsc{embed} remains stable.}
  \label{fig:strategy}
\end{figure}
